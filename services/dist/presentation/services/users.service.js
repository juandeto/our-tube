...
class UsersService {
    ...
    getUserByUsername(listId, username) {
        ...
        const user = usersOfList.find((user) => (user === null || user === void 0 ? void 0 : user.username) === username);
        if (!user) {
    ...
    updateUser(listId, body) {
        ...
        const indexToUpdate = usersOfList.findIndex((user) => (user === null || user === void 0 ? void 0 : user.username) === (body === null || body === void 0 ? void 0 : body.username));
        if (indexToUpdate === -1) {
            return { error: 'username not found' };
        }
        usersOfList[indexToUpdate] = Object.assign(Object.assign({}, usersOfList[indexToUpdate]), body);
    ...
    startPlaylist(listId) {
        ...
        const updateUsers = usersOfList.map((user) => {
            if ((user === null || user === void 0 ? void 0 : user.status) && user.host) {
