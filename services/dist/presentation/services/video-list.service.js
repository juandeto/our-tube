...
class VideoListService {
    ...
    get activeVideoLists() {
        return this._videoList.filter((vl) => (vl === null || vl === void 0 ? void 0 : vl.status) !== 'DELETED');
    }
    ...
    updateVideoList(id, updateBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (currentList === null || currentList === void 0 ? void 0 : currentList.error) {
            ...
            try {
                const updatedVideoList = yield postgres_1.prisma.videoList.update({
                    ...
                    data: {
                        status: status ? status : (_a = currentList.result) === null || _a === void 0 ? void 0 : _a.status,
                        title: title ? title : (_b = currentList.result) === null || _b === void 0 ? void 0 : _b.title,
                        subject: subject ? subject : (_c = currentList.result) === null || _c === void 0 ? void 0 : _c.subject,
                    },
                });
